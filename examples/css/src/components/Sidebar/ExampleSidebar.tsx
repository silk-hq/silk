...
const ExampleSidebar = () => {
  return (
    <Sidebar.Root>
      <Sidebar.Trigger className="ExampleSidebar-presentTrigger">Sidebar</Sidebar.Trigger>
      <Sidebar.Portal>
        <Sidebar.View>
          <Sidebar.Backdrop />
          <Sidebar.Content className="ExampleSidebar-content">
                      ...
                      <ul className="ExampleSidebar-list">
                        {section.items.map((item) => (
                          <li className="ExampleSidebar-item" key={item.name}>
                            <div className="ExampleSidebar-itemIcon">{item.icon}</div>
                            <div className="ExampleSidebar-itemText">{item.name}</div>
                          </li>
                        ))}
                      </ul>
                    </div>
